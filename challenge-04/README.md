...
carro.adicionarPessoas = function(numeroPessoas){
    ...
    var pluralCabem = vagas === 1 ? 'cabe' : 'cabem';
    var pluralVagas = vagas === 1 ? ' pessoa' : ' pessoas';
    var pluralTotal = total === 1 ? ' pessoa' : ' pessoas';
	...
	return 'Só ' + pluralCabem + ' mais ' + vagas + pluralVagas + '!';
    }

    carro.quantidadePessoas += numeroPessoas;
    return 'Já temos ' + total + pluralTotal + ' no carro!';
};
